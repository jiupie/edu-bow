...
public class EncryptBodyRequestWrapper extends HttpServletRequestWrapper {
    ...
    private byte[] body;
    private final EncryptHandler encryptService;

    public EncryptBodyRequestWrapper(HttpServletRequest request, EncryptHandler encryptService) throws IOException {
        super(request);
